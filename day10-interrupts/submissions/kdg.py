...
class ApprovalState(TypedDict):
    action_details: str # 승인할 작업 내용
    status: Optional[Literal["pending", "approved", "rejected"]] # 상태

# 2. 승인 노드 - interrupt() 호출 후 결과에 따라 proceed/cancel 노드로 이동
...
from langchain_openai import ChatOpenAI  # Anthropic → OpenAI로 변경
